...
## Морфологический разбор на сайте

Вкладка «Һүҙ составы» (`/#morphology`) показывает словарную основу, аффиксы,
все найденные варианты разбора и легенду грамматических меток на башкирском.
API: `POST /analyze` с JSON `{"word": "халыҡтарҙыңмы"}`.
Анализатор следует цепочкам правил без ограничения Hunspell в две суффиксальные
стадии. Подробности, ограничения и проверки: [описание реализации](reports/morphology-tab-2026-09-05.md).
